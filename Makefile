#############################################################################
# Makefile for building: gch_3.app/Contents/MacOS/gch_3
# Generated by qmake (3.1) (Qt 6.7.0)
# Project:  gch_3.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile gch_3.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = gch_31.0.0
DISTDIR = /Users/pafonin/Work/Расписания/SchedulingSolverGUI/.tmp/gch_31.0.0
...
LIBS          = $(SUBLIBS) -F/opt/homebrew/lib -L/Users/pafonin/Work/Расписания/SchedulingSolverGUI -lSchedulingSolver -Wl,-rpath,/Users/pafonin/Work/Расписания/SchedulingSolverGUI -framework QtWidgets -framework QtGui -framework AppKit -framework ImageIO -framework Metal -framework QtCore -framework IOKit -framework DiskArbitration -framework AGL -framework OpenGL   
...
SOURCES       = GlobalState.cpp \
		...
		moc_GanttChartWidget.cpp \
		moc_MainWindow.cpp
OBJECTS       = GlobalState.o \
		GanttChart.o \
		GanttChartWidget.o \
		MainWindow.o \
		main.o \
		qrc_resources.o \
		moc_GanttChartWidget.o \
		moc_MainWindow.o
DIST          = .gitignore \
		operation_data.json \
		...
		gch_3.pro GlobalState.h \
		GanttChart.h \
		GanttChartWidget.h \
		MainWindow.h \
		InputData.h \
		Solver.h \
		OutputData.h GlobalState.cpp \
		GanttChart.cpp \
		GanttChartWidget.cpp \
		MainWindow.cpp \
		main.cpp
QMAKE_TARGET  = gch_3
DESTDIR       = 
TARGET        = gch_3.app/Contents/MacOS/gch_3

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 15.1
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/pafonin/Work/Расписания/SchedulingSolverGUI/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/pafonin/Work/Расписания/SchedulingSolverGUI/gch_3.pro
...
gch_3.app/Contents/MacOS/gch_3: ui_mainwindow.h $(OBJECTS)  
	@test -d gch_3.app/Contents/MacOS/ || mkdir -p gch_3.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: gch_3.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.7.0_2/share/qt/mkspecs/common/macx.conf \
...
gch_3.app/Contents/PkgInfo: 
	@test -d gch_3.app/Contents || mkdir -p gch_3.app/Contents
	@$(DEL_FILE) gch_3.app/Contents/PkgInfo
	@echo "APPL????" > gch_3.app/Contents/PkgInfo
gch_3.app/Contents/Info.plist: 
	@test -d gch_3.app/Contents || mkdir -p gch_3.app/Contents
	@$(DEL_FILE) gch_3.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.gch-3,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.gch-3,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,gch_3,g" -e "s,@LIBRARY@,gch_3,g" -e "s,\$${EXECUTABLE_NAME},gch_3,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >gch_3.app/Contents/Info.plist

all: Makefile \
		gch_3.app/Contents/PkgInfo \
		gch_3.app/Contents/Info.plist gch_3.app/Contents/MacOS/gch_3
...
distdir: FORCE
	...
	$(COPY_FILE) --parents GlobalState.h GanttChart.h GanttChartWidget.h MainWindow.h InputData.h Solver.h OutputData.h $(DISTDIR)/
	$(COPY_FILE) --parents GlobalState.cpp GanttChart.cpp GanttChartWidget.cpp MainWindow.cpp main.cpp $(DISTDIR)/
...
qrc_resources.cpp: resources.qrc \
		...
		resources/data.png \
		resources/icons8-rocket-64.png
...
compiler_moc_header_make_all: moc_GanttChartWidget.cpp moc_MainWindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_GanttChartWidget.cpp moc_MainWindow.cpp
moc_GanttChartWidget.cpp: GanttChartWidget.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/pafonin/Work/Расписания/SchedulingSolverGUI/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/pafonin/Work/Расписания/SchedulingSolverGUI -I/Users/pafonin/Work/Расписания/SchedulingSolverGUI/json/include -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/16/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib GanttChartWidget.h -o moc_GanttChartWidget.cpp
...
GanttChartWidget.o: GanttChartWidget.cpp GanttChartWidget.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		/opt/homebrew/lib/QtGui.framework/Headers/QImage \
		/opt/homebrew/lib/QtGui.framework/Headers/qimage.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o GanttChartWidget.o GanttChartWidget.cpp
...
moc_GanttChartWidget.o: moc_GanttChartWidget.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_GanttChartWidget.o moc_GanttChartWidget.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/gch_3/bin || mkdir -p $(INSTALL_ROOT)/opt/gch_3/bin
	$(DEL_FILE) -r $(INSTALL_ROOT)/opt/gch_3/bin/gch_3.app
	
	$(QINSTALL) gch_3.app $(INSTALL_ROOT)/opt/gch_3/bin/gch_3.app

uninstall_target: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/gch_3/bin/gch_3.app
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/gch_3/bin/ 
