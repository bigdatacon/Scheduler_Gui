#############################################################################
# Makefile for building: gch_2
# Generated by qmake (3.1) (Qt 5.15.3)
# Project:  gch_2.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile gch_2.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = gch_21.0.0
DISTDIR = /home/user1/QT_Projects/gch_2/.tmp/gch_21.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
gch_2: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: gch_2.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
moc_secondwindow.cpp: secondwindow.h \
		...
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /home/user1/QT_Projects/gch_2/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++ -I/home/user1/QT_Projects/gch_2 -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/11 -I/usr/include/x86_64-linux-gnu/c++/11 -I/usr/include/c++/11/backward -I/usr/lib/gcc/x86_64-linux-gnu/11/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include secondwindow.h -o moc_secondwindow.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/gch_2/bin || mkdir -p $(INSTALL_ROOT)/opt/gch_2/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/gch_2/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/gch_2/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/gch_2/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/gch_2/bin/ 
