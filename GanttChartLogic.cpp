...
void GanttChartLogic::LoadJsonData(const QString &sFilename) {
    JsonReader oReader;
    oReader.ReadOperationsFromFile(sFilename, m_vJsOperations, m_vMsOperations);
    InitializeColors();
}

void GanttChartLogic::InitializeColors() {
...
void GanttChartLogic::DrawGanttChart(QPainter *pPainter, int iScreenWidth, int iScreenHeight) {
